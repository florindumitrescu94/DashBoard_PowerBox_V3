...
//
// ASCOM Switch driver for DashBoardPowerBoxV3
//
//
// Implements:	ASCOM Switch interface version: 3
...
namespace ASCOM.DashBoardPowerBoxV3.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.DashBoardPowerBoxV3.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.DashBoardPowerBoxV3.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _DashBoardPowerBoxV3 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("775b17ed-03a3-4f80-87bd-6f7a07972c24")]
    [ProgId("ASCOM.DashBoardPowerBoxV3.Switch")]
    [ServedClassName("ASCOM Switch Driver for DashBoardPowerBoxV3")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DashBoardPowerBoxV3"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "DashBoardPowerBoxV3.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
